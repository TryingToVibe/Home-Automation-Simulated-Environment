...
public class MainMenuController {
	...
	public void initialize() {
		...
		//makes the buttons scale to window size
		deleteRuleButton.prefHeightProperty().bind(
				ruleVBox.heightProperty().multiply(0.05)
				);
		...
		registerRoomButton.prefHeightProperty().bind(
				ruleVBox.heightProperty().multiply(0.05)
				);
